...
const en = {
 ...
 הקפד לאחסן אותם במקום בטוח.
    ...
    "billing.resume_subscription": "המשך מנוי", // In English: "Resume Subscription"
    "billing.subscription_cancelled": "המנוי שלך בוטל", // In English: "Your subscription has been canceled."
    "billing.subscription_cancelled_description": "עדיין תהיה לך גישה למנוי עד סוף תקופת התשלום.", // In English: "You will still have access to your subscription until the end of this billing period."
    ...
    "billing.ai_access": "גישה לבינה מלאכותית", // In English: "AI Access"
    ...
    "billing.switch_to": "החלפה ל %strong%", // In English: "Switch to %strong%"
    "billing.payment_setup": "הגדרת תשלום", // In English: "Payment Setup"
    "billing.back": "חזרה", // In English: "Back"
    "billing.you_are_now_subscribed_to": "הינך מנוי לסוג %strong%", // In English: "You are now subscribed to %strong% tier."
    "billing.you_are_now_subscribed_to_without_tier": "עכשיו אתה מנוי", // In English: "You are now subscribed"
    "billing.subscription_cancellation_confirmation": "האם הנך בטוח שאתה מעוניין לבטל את המנוי", // In English: "Are you sure you want to cancel your subscription?"
    "billing.subscription_setup": "הגדרת מנוי", // In English: "Subscription Setup"
    "billing.cancel_it": "ביטול", // In English: "Cancel It"
    "billing.keep_it": "שמירה", // In English: "Keep It"
    "billing.subscription_resumed": "%strong% המנוי שלך התחדש", // In English: "Your %strong% subscription has been resumed!"
    "billing.upgrade_now": "שדרגו עכשיו", // In English: "Upgrade Now"
    "billing.upgrade": "שדרוג", // In English: "Upgrade"
    "billing.currently_on_free_plan": "אתם כרגע מנויים למנוי חינמי", // In English: "You are currently on the free plan."
    "billing.download_receipt": "הורדת מתכון", // In English: "Download Receipt"
    "billing.subscription_check_error": "קרתה תקלה בזמן בדיקת סטאטוס המנוי", // In English: "A problem occurred while checking your subscription status."
    "billing.email_confirmation_needed": "האימייל שלכם אושר, נשלח קוד לאשר אותו כרגע", // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
    "billing.sub_cancelled_but_valid_until": "ביטלתם את המנוי והוא יעבור לחינמי בסוף תקופת החיוב. לא תחויבו שוב אלא אם תשדרגו חזרה" , // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
    "billing.current_plan_until_end_of_period": "התכנית העכשווית עד סוף תקופת החיוב", // In English: "Your current plan until the end of this billing period."
    "billing.current_plan": "תכנית עכשווית", // In English: "Current plan"
    "billing.cancelled_subscription_tier": "מנוי מבוטלת (%%)", // In English: "Cancelled Subscription (%%)"
    ...
    "billing.enjoy_msg": "תהנו מ(%%) של אחסון בענן בנוסף לעוד הטבות.", // In English: "Enjoy %% of Cloud Storage plus other benefits."
  },
};
